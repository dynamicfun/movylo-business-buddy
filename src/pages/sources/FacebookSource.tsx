...
export default function FacebookSource() {
  ...
  return (
    <InnerPageTemplate
      title="Facebook"
      subtitle="Turn people who follow you on Facebook into customers"
      helperText="Nothing happens until customers choose to join."
      introText="Connect your Facebook page so people who find you there can join your business and stay in touch."
      icon={Facebook}
      backTo="/"
    >
          ...
          <Card className="border-muted">
            <CardContent className="p-5">
              ...
              <ul className="space-y-2.5">
                {[
                  "People who find you on Facebook can join your business",
                  "Movylo shares occasional updates for you",
                  "You can review or change this anytime",
                  "Customers stay connected after they leave Facebook"
                ].map((item, index) => (
                ...
                <div className="space-y-4">
                  <div className="flex items-center gap-3 p-3 bg-primary/5 rounded-lg">
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="font-medium text-sm text-foreground">Your Business Page</p>
