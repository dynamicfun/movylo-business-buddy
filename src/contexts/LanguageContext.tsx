...
const translations: Record<LanguageCode, Translations> = {
  it: {
    ...
    findNewCustomersVia: "Trova nuovi clienti tramite",
    social: "Social",
    inStoreSource: "Nel tuo locale",
    otherSources: "Altre fonti",
    shareLinkSubtitle: "Invia un link ai tuoi clienti",
    googleProfile: "Il tuo profilo Google",
    googleSubtitle: "Fatti trovare su Google",
    otherSourcesSubtitle: "Scopri altri modi per aggiungere clienti",
    // Activity Card
    activity: "Attività",
  ...
  en: {
    ...
    findNewCustomersVia: "Find new customers via",
    social: "Social",
    inStoreSource: "In your store",
    otherSources: "Other sources",
    shareLinkSubtitle: "Send a link to your customers",
    googleProfile: "Your Google Profile",
    googleSubtitle: "Get found on Google",
    otherSourcesSubtitle: "Discover other ways to add customers",
    // Activity Card
    activity: "Activity",
  ...
  es: {
    ...
    findNewCustomersVia: "Encuentra nuevos clientes mediante",
    social: "Social",
    inStoreSource: "En tu local",
    otherSources: "Otras fuentes",
    shareLinkSubtitle: "Envía un enlace a tus clientes",
    googleProfile: "Tu perfil de Google",
    googleSubtitle: "Hazte encontrar en Google",
    otherSourcesSubtitle: "Descubre otras formas de agregar clientes",
    // Activity Card
    activity: "Actividad",
  ...
  fr: {
    ...
    findNewCustomersVia: "Trouvez de nouveaux clients via",
    social: "Social",
    inStoreSource: "Dans votre magasin",
    otherSources: "Autres sources",
    shareLinkSubtitle: "Envoyez un lien à vos clients",
    googleProfile: "Votre profil Google",
    googleSubtitle: "Soyez trouvé sur Google",
    otherSourcesSubtitle: "Découvrez d'autres façons d'ajouter des clients",
    // Activity Card
    activity: "Activité",
  ...
  de: {
    ...
    findNewCustomersVia: "Finden Sie neue Kunden über",
    social: "Social",
    inStoreSource: "In Ihrem Geschäft",
    otherSources: "Andere Quellen",
    shareLinkSubtitle: "Senden Sie einen Link an Ihre Kunden",
    googleProfile: "Ihr Google-Profil",
    googleSubtitle: "Auf Google gefunden werden",
    otherSourcesSubtitle: "Entdecken Sie andere Möglichkeiten, Kunden hinzuzufügen",
    // Activity Card
    activity: "Aktivität",
